...
/**
* This class represents amateur difficulty level of the game, implements Difficulty interface and extends GameMode class. Represents one of the concrete strategies in Strategy DP and defines methods for setting difficulty and budget size of the game.
* 
*  @author Šimon Vinkler
*  @version 1.0
*  @since 1.3.2024
*/
public class AmateurDifficulty extends GameMode implements Difficulty {
    /**
     * This method is used to set difficulty level of the game
     */
    @Override
    public void setDifficulty() {
        this.addDifficulty("Amateur");
    }
